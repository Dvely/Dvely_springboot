...
public enum AuditAction {
    ...
    // 카탈로그 개정(2026-09-06): 자동 재시작(SERVER_RECOVERY_ATTEMPTED)을 했는데도 settle 유예가 지나도록
    // 앱이 계속 무응답 — 자가치유 실패라 사용자 개입(로그·재배포)이 필요하다는 시스템 신호. 에피소드당 1회.
    SERVER_RECOVERY_FAILED(AuditCategory.INFRA);
