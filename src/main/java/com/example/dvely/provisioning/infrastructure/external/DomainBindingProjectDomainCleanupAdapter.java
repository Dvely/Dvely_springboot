...
/**
 * ProjectDomainCleanupPort 구현 — domainbinding 의 시스템 정리(releaseBackendDomains)를 호출해 다리를
...
public class DomainBindingProjectDomainCleanupAdapter implements ProjectDomainCleanupPort {
    ...
    public void releaseBackendDomains(Long projectId, String ipAddress) {
        domainBindingCommandService.releaseBackendDomains(projectId, ipAddress);
    }
}
