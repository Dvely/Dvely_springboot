...
| PAT | `danto/agent-pat` | **구현 완료 · PR #306 리뷰 대기 (2026-09-08)** | EPIC 05 (Agent) | 에이전트용 개인 액세스 토큰. MC 단위의 유일한 선행 요건. 해시 저장, `qp_` 접두사 필터 분기, 스코프는 HTTP 메서드로 강제. 엔드포인트 3개, V60. 실 서버 HTTP 검증 10건 통과. Issue #304, `state.md` §4.22, `api.md` §18 |
